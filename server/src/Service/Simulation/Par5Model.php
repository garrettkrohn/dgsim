...
class Par5Model extends BaseModel
{
    ...
    private function getHoleResult($rng, $oddsOfResultsArray): HoleResultDto
    {
        ...
        if ($rng < $benchmark) {
            return new HoleResultDto(7, 2,0, false, false, false, false, $rng);
        }
        ...
        if ($rng < $benchmark) {
            return new HoleResultDto(5, 1,0, false,false, false, true, $rng);
        }
        $benchmark += $oddsOfResultsArray->resultId9;
        if ($rng < $benchmark) {
            return new HoleResultDto(7, 3,1, false,false, true, false, $rng);
        }
        $benchmark += $oddsOfResultsArray->resultId8;
        if ($rng < $benchmark) {
            return new HoleResultDto(6, 2,1, false,false, true, false, $rng);
        }
        $benchmark += $oddsOfResultsArray->resultId7;
        if ($rng < $benchmark) {
            return new HoleResultDto(5, 1,1, false,false, true, false, $rng);
        }
        $benchmark += $oddsOfResultsArray->resultId6;
        if ($rng < $benchmark) {
            return new HoleResultDto(4, 0,1, false,false, true, false, $rng);
        }
        $benchmark += $oddsOfResultsArray->resultId5;
        if ($rng < $benchmark) {
            return new HoleResultDto(7, 4,0, false,true, true, false, $rng);
        }
        $benchmark += $oddsOfResultsArray->resultId4;
        if ($rng < $benchmark) {
            return new HoleResultDto(6, 3,0, false,true, true, false, $rng);
        }
        $benchmark += $oddsOfResultsArray->resultId3;
        if ($rng < $benchmark) {
            return new HoleResultDto(5, 2,0, false,true, true, false, $rng);
        }
        $benchmark += $oddsOfResultsArray->resultId2;
        if ($rng < $benchmark) {
            return new HoleResultDto(4, 1,0, false,true, true, false, $rng);
        }
