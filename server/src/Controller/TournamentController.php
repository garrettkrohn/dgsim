...
class TournamentController extends ApiController
{
    ...
    #[Route('api/lastTournament/{auth0}', methods: ('GET'))]
    public function getMostRecentPlayerTournament(string $auth0): Response
    {
        return $this->json($this->tournamentService->getLastPlayerTournament($auth0));
    }
